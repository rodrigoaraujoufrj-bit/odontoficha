...
| `pacientes` | Nome, telefone, e-mail, CPF, data de nascimento, observações | Identificar o paciente e viabilizar o atendimento | Tutela da saúde (uma vez vinculado a atendimento clínico) | Profissional(is) vinculado(s) ao paciente no consultório | Mínimo 20 anos após o último registro; recomendação de guarda indefinida | Supabase |
